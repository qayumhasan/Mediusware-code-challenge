                ...
                <div class="card shadow mb-4">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <strong class="text-danger">{{errors.sku[0]}}</strong>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr v-for="variant_price in product_variant_prices">
                                    ...
                                    <td>
                                        <input type="text" required class="form-control" v-model="variant_price.price">
                                    </td>
                                    <td>
                                        <input type="text" required class="form-control" v-model="variant_price.stock">
                                    </td>
                                </tr>
                                </tbody>
                            </table>
